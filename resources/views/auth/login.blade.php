      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block"><img src="\image\desk.png"  width='480' height='450' ></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login <br> Berita Acara Pemenuhan Data</h1>
                  </div>
                  <form action="{{ route('login.ba') }}" method="POST" class="user">
                   @csrf
                    @if ($errors->any())
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{ route('register') }}">Daftar sebagai Pemeriksa!</a>
                  </div>
                </div>
              </div>
            </div>
