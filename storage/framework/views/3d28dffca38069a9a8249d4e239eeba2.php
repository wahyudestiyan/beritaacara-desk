...
<tr>
    ...
    <td><a href="<?php echo e(route('signpadprod.save')); ?>" type="button" class="btn btn-secondary">TandaTangan Produsen</a> </td>
    <td width="500"></td> 
    <td><a href="<?php echo e(route('signpad.save')); ?>" type="button" class="btn btn-warning">TandaTangan Walidata</a></td>
    </tr>
    </table>   
    <table  align="right">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\DESTIYAN\LATIHAN LARAVEL\BERITA ACARA DESK APP\beritaacara-desk\resources\views/ba/show.blade.php ENDPATH**/ ?>